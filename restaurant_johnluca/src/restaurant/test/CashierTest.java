...
public class CashierTest extends TestCase
{
        ...
        public void testInitialization() { //tests to ensure Cashier is constructed properly
//        	  customer1.cashier = cashier;//You can do almost anything in a unit test.                        
        ...
        public void testOneNormalCustomerScenario()
        {
            ...
            cashier.msgComputeBill(customer1, "Tofu", waiter);
            ...
            assertTrue("myCustomer list has stored wrong choice", cashier.getMyCustomers().get(0).getChoice().equals("Tofu"));
